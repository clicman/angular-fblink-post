...
class Media {
    ...
    static function mediaYoutube($url) {
        ...
        if (preg_match("/(.*?)v=(.*?)($|&)/i", $url, $matching)) {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $vid . '" style="margin-bottom: 5px;" width="100%" height="368" src="http://www.youtube.com/embed/' . $vid . '" frameborder="0" allowfullscreen></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaVimeo($url) {
        ...
        if ($breakUrl[1] != "") {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $imgId . '" style="margin-bottom: 5px;" width="100%" height="281" src="http://player.vimeo.com/video/' . $imgId . '" width="100%" height="368" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen ></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaMetacafe($url) {
        ...
        if ($matching[1] != "") {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $vid . '" style="margin-bottom: 5px;" width="100%" height="368" src="http://www.metacafe.com/embed/' . $vid . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaDailymotion($url) {
        ...
        if ($id != "") {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $id . '" style="margin-bottom: 5px;" width="100%" height="368" src="http://www.dailymotion.com/embed/video/' . $id . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaCollegehumor($url) {
        ...
        if ($id != "") {
            ...
            $hash = json_decode($hash, true);
            array_push($media, $hash['thumbnail_url']);
            array_push($media, '<iframe id="' . date("YmdHis") . $id . '" style="margin-bottom: 5px;" width="100%" height="368" src="http://www.collegehumor.com/e/' . $id . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaBlip($url) {
        ...
        if ($url != "") {
            ...
            $src = $matching[1];
            array_push($media, $hash['thumbnail_url']);
            array_push($media, '<iframe id="' . date("YmdHis") . 'blip" style="margin-bottom: 5px;" width="100%" height="368" src="' . $src . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaFunnyordie($url) {
        ...
        if ($url != "") {
            ...
            $src = $matching[1];
            array_push($media, $hash['thumbnail_url']);
            array_push($media, '<iframe id="' . date("YmdHis") . 'funnyordie" style="margin-bottom: 5px;" width="100%" height="368" src="' . $src . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
